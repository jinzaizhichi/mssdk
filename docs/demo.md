...
stock_hfq_df = ms.stock_zh_a_daily(symbol="sh600000", adjust="hfq")  # 利用 mssdk 一行获取复权数据
...
![](https://jfds-1252952517.cos.ap-chengdu.myqcloud.com/mssdk/readme/strategy/Figure_0.png)
...
def main(code="sh601318", start_cash=1000000, stake=100, commission_fee=0.001):
    ...
    stock_zh_a_daily_df = ms.stock_zh_a_daily(
