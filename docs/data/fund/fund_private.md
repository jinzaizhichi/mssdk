...
```python
import mssdk as ms
amac_person_org_list_df = ms.amac_person_org_list()
...
```python
import mssdk as ms
amac_person_org_list_ext_df = ms.amac_person_org_list_ext()
...
```python
import mssdk as ms
amac_manager_xxgs_hmd_df = ms.amac_manager_xxgs_hmd()
...
```python
import mssdk as ms
amac_manager_xxgs_jlcf_df = ms.amac_manager_xxgs_jlcf()
...
```python
import mssdk as ms
amac_manager_xxgs_cxdj_df = ms.amac_manager_xxgs_cxdj()
...
```python
import mssdk as ms
zdzk_se = ms.zdzk_fund_index(index_type=32, plot=True)
print(zdzk_se.name)
print(zdzk_se)
```
...
![](https://jfds-1252952517.cos.ap-chengdu.myqcloud.com/mssdk/readme/index/zdzd_index.png)
