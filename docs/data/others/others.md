...
```python
import mssdk as ms
fortune_df = ms.fortune_rank_eng(year="2015")
print(fortune_df)
```
...
```python
import mssdk as ms
box_office_spot_df = ms.box_office_spot()
