## [mssdk](https://github.com/msfamily/mssdk) 股票数据
...
限量: 单次返回指定 A 股上市公司指定日期间的历史行情日频率数据, 多次获取容易封禁 IP
...
描述: 新浪财经股票或者指数的分时数据，目前可以获取 1, 5, 15, 30, 60 分钟的数据频率, 可以指定是否复权
...
11  12                      阿卡迈技术   113.38  ...    18461647373   31.60  105.msAM
...
```python
import mssdk as ms
stock_zh_a_gdhs_df = ms.stock_zh_a_gdhs()
...
| 名称   | 类型 | 描述   |
| -------- | ---- |  --- |
| symbol | str |  symbol="网络安全"; 可以通过调用 **ms.stock_board_concept_name_em** 查看东方财富-概念板块的所有概念名称|
