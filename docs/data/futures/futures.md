## [mssdk](https://github.com/akfamily/mssdk) 期货数据
...
在 [mssdk](https://github.com/akfamily/mssdk) 中可以通过 **get_roll_yield_bar** 接口下载展期收益率数据.
...
```python
import mssdk as ms
futures_index_cscidx_df = ms.futures_index_cscidx(index_name="林木综合指数", start_date="2010-01-01", end_date="2020-04-06")
...
| 名称   | 类型 | 描述       |
| -------- | ---- | --- |
| symbol | str | symbol="IF2008"; 具体合约(期货品种符号需要大写), 可以通过调用 ms.match_main_contract(exchange="cffex") 接口获取, 或者访问网页获取 |
