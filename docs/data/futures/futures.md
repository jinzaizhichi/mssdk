...
| 名称         | 类型  | 描述                                                                            |
|------------|-----|-------------------------------------------------------------------------------|
| symbol     | str | symbol="IF0"; 请参考 **新浪连续合约品种一览表**, 也可通过 **ms.futures_display_main_sina()** 获取 |
...
futures_main_sina_hist = ms.futures_main_sina(symbol="V0", start_date="20200101", end_date="20220101")
