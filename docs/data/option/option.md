...
```python
import mssdk as ms
option_df = ms.option_finance_board(symbol="华夏上证50ETF期权", end_month="2003")
print(option_df)
```
...
```python
import mssdk as ms
option_df = ms.option_finance_board(symbol="嘉实沪深300ETF期权", end_month="2003")
print(option_df)
```
...
```python
import mssdk as ms
option_df = ms.option_finance_board(symbol="沪深300股指期权", end_month="2003")
print(option_df)
```
...
```python
import mssdk as ms
option_sina_cffex_hs300_spot_df = ms.option_sina_cffex_hs300_spot(contract="io2004")
...
```python
import mssdk as ms
part_1, part_2, part_3 = ms.get_shfe_option_daily(trade_date="20191017", symbol="天胶期权")
print(part_1)
print(part_2)
print(part_3)
```
